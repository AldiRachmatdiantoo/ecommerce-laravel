            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.service.update', $service->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('price') is-invalid @enderror"
                                    id="price" name="price" value="{{ $service->price }}" step="0.01" min="0"
                                    required>
                            </div>
                            @error('price')
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="duration" class="form-label">Durasi (contoh: '60 menit', '1 hari') <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('duration') is-invalid @enderror"
                                id="duration" name="duration" value="{{ $service->duration }}" required>
                            @error('duration')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="mb-4">
                        ...
                        @if ($service->image_url)
                            <img src="{{ $service->image_url }}" alt="Current Image" class="img-thumbnail mt-2"
                                width="150">
                        @endif
                        @error('image')
                            <div class="invalid-feedback">
